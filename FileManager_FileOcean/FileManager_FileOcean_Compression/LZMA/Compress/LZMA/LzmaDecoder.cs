    ...
    public class Decoder : ICoder, ISetDecoderProperties // ,System.IO.Stream
    {
        class LenDecoder
        {
            ...
            public void Create(uint numPosStates)
            {
                ...
                {
                    m_LowCoder[posState] = new RangeBitTreeDecoder(Base.kNumLowLenBits);
                    m_MidCoder[posState] = new RangeBitTreeDecoder(Base.kNumMidLenBits);
                }
        ...
        RangeCoder.RangeDecoder m_RangeDecoder = new RangeCoder.RangeDecoder();

        RangeBitDecoder[] m_IsMatchDecoders = new RangeBitDecoder[Base.kNumStates << Base.kNumPosStatesBitsMax];
        RangeBitDecoder[] m_IsRepDecoders = new RangeBitDecoder[Base.kNumStates];
        RangeBitDecoder[] m_IsRepG0Decoders = new RangeBitDecoder[Base.kNumStates];
        RangeBitDecoder[] m_IsRepG1Decoders = new RangeBitDecoder[Base.kNumStates];
        RangeBitDecoder[] m_IsRepG2Decoders = new RangeBitDecoder[Base.kNumStates];
        RangeBitDecoder[] m_IsRep0LongDecoders = new RangeBitDecoder[Base.kNumStates << Base.kNumPosStatesBitsMax];

        RangeBitTreeDecoder[] m_PosSlotDecoder = new RangeBitTreeDecoder[Base.kNumLenToPosStates];
        RangeBitDecoder[] m_PosDecoders = new RangeBitDecoder[Base.kNumFullDistances - Base.kEndPosModelIndex];
