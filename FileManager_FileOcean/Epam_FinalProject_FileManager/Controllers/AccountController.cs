...
namespace Epam_FinalProject_FileManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, UserStorageSize = DefaultUserStorageSize };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!Directory.Exists(userFilesPath + applicationUser.Id + "/"))
                    {
                        Directory.CreateDirectory(userFilesPath + applicationUser.Id + "/");
                    }
