$(document).ready(function () {
    ...
    $('#fileUploadButton').fileupload({
        ...
        fail: function (e, data) {
            data.context.html(
                 "<td><span class='glyphicon glyphicon-remove-circle red'></span>  Max allowed file size is 2000Mb.  </td> </tr>");
        }
    });
...
function FileSharingDone(element) {
    ...
    if (access == "accessOff") {
        $.ajax({
            type: "POST",
            url: "/PublicStorage/DeleteShareLink",
...
function UpdateFreeStorageSizeRequest() {
    $.ajax({
        type: "GET",
        url: "/PublicStorage/UserStorageSize",
        success: function (data) {
